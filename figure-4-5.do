...
log using figure-4-5.log, replace
...
graph export graph/tmp451.pdf, replace
...
graph export graph/tmp452.pdf, replace


ttest y, by(d)
table d, c(mean y mean ytminus2 mean ytminus1) format(%9.2f)
